class NutriScoreFilter {
  constructor() {
    this.filterButtons = document.querySelectorAll(".nutri-score-filter");
    this.currentGrade = "";
    this.allProducts = [];
  }
  ...
  clickedFilterBtn() {
    this.filterButtons.forEach((btn) => {
      btn.addEventListener("click", () => {
        this.currentGrade = btn.dataset.grade.toLowerCase();
  ...
  updateActiveButton(activeBtn) {
    ...
    if (activeBtn.dataset.grade.toLowerCase() === "all") {
      this.currentGrade = "";
    }
  }
  ...
  filterProducts() {
    ...
    if (!this.allProducts || !container) return;
    let filtered = this.allProducts;
    if (this.currentGrade && this.currentGrade !== "all") {
      filtered = filtered.filter(
        (product) => product.nutritionGrade === this.currentGrade
      );
    }
  ...
  createProductCard(product) {
    ...
    return `
      <div 
        ...
        data-nutri-grade="${nutriScore.toLowerCase()}"
      >
...
export default NutriScoreFilter;
